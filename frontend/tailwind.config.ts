  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        devanagari: ["var(--font-noto-devanagari)", "ui-sans-serif", "sans-serif"],
      },
      colors: {
        // shadcn semantic tokens, mapped to our warm-beige / warm-dark palette.
      ...
      animation: {
        ...
        "gradient": "shimmer 6s ease-in-out infinite",
      },
    },
  },
  plugins: [animate],
