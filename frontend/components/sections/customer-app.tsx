        ...
        <div className="relative h-[440px] w-[220px] overflow-hidden rounded-[28px] bg-gradient-to-b from-primary/15 to-background">
          ...
          <div className="p-4">
            ...
            <div className="mt-4 space-y-2">
              <MiniClinicRow name="Pratiksha" status="Open · Next slot 11:15" />
              <MiniClinicRow name="Aroma Salon" status="Open · Next slot 12:00" />
              <MiniClinicRow name="Serenity Spa" status="Closed · Opens 15:00" muted />
            </div>
          </div>
        </div>
      </div>
...
function MiniClinicRow({
  ...
  return (
    <div className="rounded-lg border border-border/50 bg-card/70 p-2.5">
      ...
      <div className="mt-0.5 text-[10px] text-muted-foreground">Clinic · Indore</div>
      <div
        className={
